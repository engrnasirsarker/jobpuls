@extends('auth.layout')
@section('content')
<div class="bg-gray-400 dark:bg-gray-800 h-screen overflow-hidden flex items-center justify-center">
  <div class="bg-white lg:w-4/12 md:4/12 w-4/12 shadow-3xl rounded-xl">
    <!-- for logo section -->
    ...
    <h2 class="text-2xl md:text-2xl font-bold leading-tight text-center pt-12">School Management System</h2>
    <form class="p-6 md:p-12 md:pt-6" action="{{ route('login') }}" method="POST">@csrf
      <div class="flex items-center text-lg mb-6 md:mb-6">
        <svg class="absolute ml-3" width="24" viewBox="0 0 24 24">
          <path d="M20.822 18.096c-3.439-.794-6.64-1.49-5.09-4.418 4.72-8.912 1.251-13.678-3.732-13.678-5.082 0-8.464 4.949-3.732 13.678 1.597 2.945-1.725 3.641-5.09 4.418-3.073.71-3.188 2.236-3.178 4.904l.004 1h23.99l.004-.969c.012-2.688-.092-4.222-3.176-4.935z"/>
        </svg>
        <input type="text" id="username" name="email" class="bg-gray-200 rounded pl-12 py-2 md:py-4 focus:outline-none w-full" placeholder="Username" />
       
        </div>
        @error('email')
        <div class="-mt-6 mb-6">
            <span class="invalid-feeddback text-red-500" role="alert">
