  ...
  <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      ...
      <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">          
            ...
            <router-link to="/employer-signup" class="font-medium text-primary-600 hover:underline dark:text-primary-500">
                <fwb-button outline size="xl" class="w-full mb-2">
                Sign in as employer
                </fwb-button>
            </router-link>

            <router-link to="/candidate-signup" class="font-medium text-primary-600 hover:underline dark:text-primary-500">
                <fwb-button outline size="xl" class="w-full">
