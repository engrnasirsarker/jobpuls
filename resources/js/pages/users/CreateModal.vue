      ...
      <template #body>
        <form class="w-full max-w-lg" method="post" v-on:submit.prevent="submitForm">
            <div class="md:flex md:items-center mb-2">
                ...
                <div class="md:w-2/3">
                    <input class="form-input" v-model="form.name" id="name" type="text" placeholder="Enter user name">
            ...
            <div class="md:flex md:items-center mb-2">
                ...
                <div class="md:w-2/3">
                    <input class="form-input" v-model="form.mobile" id="mobile" type="text" placeholder="Enter Mobile No">
                </div>
            </div>            
            <div class="md:flex md:items-center mb-2">
                <div class="md:w-2/6 text-end">
                ...
                <div class="md:w-2/3">                   
                    <select id="role" class="select-class" v-model="form.role_id">
            ...
            <div class="md:flex md:items-center mb-2">
                ...
                <div class="md:w-2/3">  
                    <select id="status" v-model="form.status" class="select-class">
            ...
            <div class="md:flex md:items-center mb-2">
                ...
                <div class="md:w-2/3">
                    <input class="form-input" v-model="form.email" id="email" type="email" placeholder="Enter user email">
            ...
            <div class="md:flex md:items-center mb-2">
                ...
                <div class="md:w-2/3">
                    <input class="form-input" v-model="form.password" id="password" type="password" placeholder="Enter user password">
                </div>
            </div>  
            <div class="md:flex md:items-center mb-2">
                <div class="md:w-2/6 text-end">
                ...
                <div class="md:w-2/3">
                    <input class="form-input" v-model="form.cpassword" id="cpassword" type="password" placeholder="Enter user password">
                </div>
            </div>            
