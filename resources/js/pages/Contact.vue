   ...
   <Card>
    ...
    <template #body>
        ...
        <div class="md:flex md:items-center mb-2">
            ...
            <div class="md:w-2/3">  
                <input type="text" class="form-input" v-model="form.page_title">
            </div>
        </div> 
        <div class="md:flex md:items-center mb-2">
            <div class="md:w-1/6 text-end">
            ...
            <div class="md:w-2/3">  
                ...
                class="form-input" cols="30" rows="3" v-model="form.company_address">
        ...
        <div class="md:flex md:items-center mb-2">
            <div class="md:w-1/6 text-end">
                <label class="form-label px-2" for="image">
                    Current Banner
                </label>
            </div>
            <div class="md:w-2/3">  
