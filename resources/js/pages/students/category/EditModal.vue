            ...
            <div class="md:flex md:items-center mb-2">
                <div class="md:w-2/6 text-end">
                    <label class="form-label px-2" for="name">
                      Category  Name <strong class="text-red-600">*</strong>
                    </label>
                </div>
                <div class="md:w-2/3">
                    <input class="form-input" v-model="editForm.student_category_name" id="name" type="text" placeholder="Enter Category name">
                    <span class="text-red-500" v-if="errors.student_category_name">
                        {{ errors.student_category_name[0] }}
                    </span>
                </div>
            </div>    
