            ...
            <div class="md:flex md:items-center mb-2">
                <div class="md:w-2/6 text-end">
                    <label class="form-label px-2" for="name">
                      Class  Name <strong class="text-red-600">*</strong>
                    </label>
                </div>
                <div class="md:w-2/3">
                    <input class="form-input" v-model="form.subject_name" id="name" type="text" placeholder="Enter subject name">
                    
                    <span class="text-red-500" v-if="errors.subject_name">
