<script setup>
    ...
    const columns = [
        ...
        {label:"Name",field:"class_name",type:"string"},
        {label:"Action",field:"action",width:'20%'},
    ]
    const createItem = async () => { 
        try {
            await axios.post(`/api/student-class`, form.value)       
            fetchData();
            form.value = { };  
    ...
    const updateItem = async () => {
        ...
        try {
            await axios.patch(`/api/student-class/${id}`, editForm.value);
    ...
    const deleteItem = (id)=>{
        ...
        confirmButtonText: 'Yes, delete it!'
            ...
            if (result.value) {
                axios.delete('/api/student-class/'+id)
                .then(fetchData())
...
<template>    
    <BreadcrumbComponent :currentPage="'Student Class'"/> 
