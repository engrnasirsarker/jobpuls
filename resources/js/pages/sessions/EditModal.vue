            ...
            <div class="md:flex md:items-center mb-2">
                <div class="md:w-2/6 text-end">
                    <label class="form-label px-2" for="name">
                      Session  Name <strong class="text-red-600">*</strong>
                    </label>
                </div>
                <div class="md:w-2/3">
                    <input class="form-input" v-model="editForm.session_name" id="name" type="text" placeholder="Enter session name">
                    <span class="text-red-500" v-if="errors.session_name">
                        {{ errors.session_name[0] }}
                    </span>
                </div>
            </div>    
